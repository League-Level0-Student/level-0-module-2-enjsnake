...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			int intFour = Integer.parseInt(fourAnswer);
			// 7) Do the same for sixAsString. 
			int intSix = Integer.parseInt(sixAnswer);
			// 8) Print the addition of fourAsInt and sixAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, intFour + intSix);
			...
			int intFive = Integer.parseInt(fiveAnswer);
			// 10) Print the addition of fourAsInt, sixAsInt, and fiveAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, intFive + intFour + intSix);
